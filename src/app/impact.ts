// TODO: if we want to value impact then it should be a smart contract... otherwise we can simply use lightning wallets with satoshi amounts as a proxy for impacts
import zValue from '../app/ztable'
